...
page_title.textContent="products";
...
products.forEach(function(v,i,a){
    ...
    card_container.style.textAlign="center"
    card_container.style.alignContent="center";
    card_container.style.backgroundColor="	white"
    
    // card_container.style.padding="10px";

    let prod_id=document.createElement("p")
    prod_id.innerText=v.id

    let prod_title=document.createElement("p")
    prod_title.innerText=v.title;

   
    
    let prod_image=document.createElement("img")
    prod_image.setAttribute("src",v.image)
    prod_image.style.background="transparent";
    prod_image.setAttribute("height","200px")
    prod_image.setAttribute("width","150px")

    let prod_price=document.createElement("p")
    prod_price.innerText=v.price;
